...
from fedprox.task import Net, load_data
from fedprox.task import test as test_fn
from fedprox.task import train as train_fn
...
def train(msg: Message, context: Context):
    ...
    mu = msg.content["config"].get("proximal-mu", 0.0)
